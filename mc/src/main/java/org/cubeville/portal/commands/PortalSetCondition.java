...
public class PortalSetCondition extends BaseCommand
{
    public PortalSetCondition() {
        super("set condition");
    ...
    public CommandResponse execute(CommandSender sender, Set<String> flags, Map<String, Object> parameters, List<Object> baseParameters)
        ...
        portal.setCondition((String) baseParameters.get(1));
        PortalManager.getInstance().save();

        return new CommandResponse("&aCondition set.");
    }
